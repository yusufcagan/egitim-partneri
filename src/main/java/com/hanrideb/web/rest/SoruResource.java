...
/**
 * REST controller for managing {@link com.hanrideb.domain.Soru}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SoruResource {
     ...
     */
    @PostMapping("/sorus")
    public ResponseEntity<Soru> createSoru(@RequestBody Soru soru) throws URISyntaxException {
     ...
     */
    @PutMapping("/sorus/{id}")
    public ResponseEntity<Soru> updateSoru(@PathVariable(value = "id", required = false) final Long id, @RequestBody Soru soru)
    ...
    public ResponseEntity<Soru> partialUpdateSoru(@PathVariable(value = "id", required = false) final Long id, @RequestBody Soru soru)
        throws URISyntaxException {
