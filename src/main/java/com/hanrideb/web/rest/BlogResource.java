...
/**
 * REST controller for managing {@link com.hanrideb.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BlogResource {
     ...
     */
    @PutMapping("/blogs/{id}")
    public ResponseEntity<Blog> updateBlog(@PathVariable(value = "id", required = false) final Long id, @RequestBody Blog blog)
    ...
    public ResponseEntity<Blog> partialUpdateBlog(@PathVariable(value = "id", required = false) final Long id, @RequestBody Blog blog)
        throws URISyntaxException {
